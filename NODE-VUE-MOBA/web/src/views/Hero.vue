<template>
  <div class="hero" v-if="heroData">
    ...
    <van-popup close-icon="close" position="top" v-model="showVideo">
      <top-bar class="hero-nav fc-w">
        <div slot="center" class="fs13 flex1"> DNF<span class="pl8">攻略站</span></div>
      ...
      <div class="hero-video-container">
        ...
        <div class="video-info">
          <img class="hero-avatar" src="../assets/images/hero/default_head.jpg" alt="">
          <div class="info">
...
.main{
  ...
  .you-like {
    ...
    .icon-related {
      ...
      width: 1rem;
      height: 1rem;
      /* background: url("../assets/images/article/lin.png") no-repeat left center; */
    }
  }
  ...
  .hero-video-container {
    ...
    .title {
      ...
      .arrow-l {
        ...
        width: 1rem;
        height: 100%;
/*         background: url("../assets/images/article/backBg.png") no-repeat center center;
  ...
  .hero {
    ...
    .hero-banner {
      ...
      .hero-info {
        ...
        li {
          ...
          .hero-attr {
            ...
            width: 0.76rem;
            height: 0.76rem;
            background: url("../assets/images/hero/hero-attrsp.png");
      ...
      .skin {
        ...
        i {
          ...
          height: 0.4rem;
          margin-left: 0.12rem;
          background: url("../assets/images/hero/skin-link.png") 0 0;
    ...
    .hero-video {
      span {
        ...
        .i-video {
          ...
          background: url("../assets/images/hero/icon_06.png");
        ...
        .i-photo {
          ...
          height: 0.8rem;
          margin-right: 0.12rem;
          background: url("../assets/images/hero/icon_07.png");
          background-size: 0.8rem;
        }
      }
    }
    ...
    .suggest {
      .card {
        ...
        &:nth-child(1) i {
          background: url("../assets/images/hero/icon_11.png") no-repeat;
          background-size: 0.52rem 0.52rem;
        }

        &:nth-child(2) i {
          background: url("../assets/images/hero/icon_13.png") no-repeat;
          background-size: 0.52rem 0.52rem;
        }

        &:nth-child(3) i {
          background: url("../assets/images/hero/icon_14.png") no-repeat;
          background-size: 0.52rem 0.52rem;
        }

        &:nth-child(4) i {
          background: url("../assets/images/hero/icon_15.png") no-repeat;
          background-size: 0.52rem 0.52rem;
        }

        &:nth-child(5) i {
          background: url("../assets/images/hero/icon_08.png") no-repeat;
          background-size: 0.52rem 0.52rem;
        }
      }
